              ...
              <div className="row">
                ...
                <div className="col-12 col-md-12 col-lg-12 col-xl-4">
                  <div className="about-us-counter">
                    <h3 className="title">
                      We’ve <Link href="/#">5+ Years</Link> Of Experience <br />
                      In Tech Services
                    </h3>
                    <p className="des">
                      Sed ut perspiciatis unde omnis iste natus error sit
                      voluptatem accusantium doloremque laudantium totam rem
                      aperiam, eaque epsa inventore
                    </p>
                    <div className="line" />
              ...
              <div className="row feature-about-wrap">
                <div className="col-12 col-sm-6 col-lg-3">
                  <div className="tf-icon-box">
                    ...
                    <h2 className="title">
                      <Link href="/#">Passionate</Link>
                    </h2>
                    <p className="des">
                      Sed ut perspiciatis unde omnis natus voluptatem accusan
                      doloremque
                    </p>
                  </div>
                </div>
                ...
                <div className="col-md-8">
                  <div className="content">
                    ...
                    <div className="flex-three name">
                      ...
                      <img
                        src="/assets/images/testimonial/name.png"
                        alt="image"
                      />
                    </div>
                    <div className="flex-three image-wrap">
                      <ul className="image-list flex-three">
                        <li>
                          <img
                            src="/assets/images/avata/avt-team1.jpg"
                            alt="Image list"
                          />
                        </li>
                        <li>
                          <img
                            src="/assets/images/avata/avt-team2.jpg"
                            alt="Image list"
                          />
                        </li>
                        <li>
                          <img
                            src="/assets/images/avata/avt-team3.jpg"
                            alt="Image list"
                          />
                        </li>
                        <li>
                          <img
                            src="/assets/images/avata/avt-team4.jpg"
                            alt="Image list"
                          />
                        </li>
                      </ul>
                    ...
                    <div className="marquee-inner to-left">
                      <ul className="marqee-list d-flex marque-slider">
                        <li className="marquee-item">
                          <span className="text-slider">Web Design</span>
                          <i className="icon-asterisk" />
                          <span className="text-slider">Digital Marketing</span>
                          <i className="icon-asterisk" />
                          <span className="text-slider">Product Design</span>
                          <i className="icon-asterisk" />
                          <span className="text-slider">Email Marketing</span>
                          <i className="icon-asterisk" />
                    ...
                    <div className="swiper-wrapper">
                      <SwiperSlide>
                        <div className="tf-team">
                          ...
                          <div className="icon-team-plus flex-five">
                      ...
                      <SwiperSlide>
                        <div className="tf-team">
                          ...
                          <div className="image relative">
                            <Link href="/team-details">
                              <img
                                src="/assets/images/team/team7.jpg"
                                alt="image"
                              />
                            </Link>
                            <ul className="social-team flex-five">
                      ...
                      <SwiperSlide>
                        <div className="tf-team">
                          ...
                          <div className="image relative">
                            <Link href="/team-details">
                              <img
                                src="/assets/images/team/team8.jpg"
                                alt="image"
                              />
                            </Link>
                            <ul className="social-team flex-five">
            ...
            <div className="tf-container">
              <div className="fact-widget fact-about-us">
                <div className="heading-title">
                  ...
                  <h2 className="title text-white">
                    Behind the Scenes <br /> Surprising Fun Facts <br /> About
                    Wiatech
                  </h2>
                </div>
                <div className="counter-area flex">
                  <div className="counter-items tf-counters">
                    ...
                    <div className="content">
                      <div
                        className="number kplus  numbers"
                        data-speed={2000}
                        data-to={5}
                        data-inviewport="yes"
                      >
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="video-about">
                    <img
                      src="/assets/images/page/video-about.jpg"
                      alt="image"
                    />
                    <VideoPopup />
                  </div>
              ...
              <div className="row mb-70">
                <div className="col-lg-12">
                  <div className="heading-title center">
                    ...
                    <h2 className="title">
                      1250+ Clients Say{" "}
                      <span className="text-blue1">About Us</span>
                    </h2>
                  </div>
                </div>
              </div>
                      ...
                      <div className="swiper-wrapper">
                        <SwiperSlide>
                          <div className="testimonial-style3 style3-h5 flex-three">
                            <div className="image">
                              <img
                                src="/assets/images/testimonial/avt.jpg"
                                alt="image"
                              />
                            </div>
                            <div className="content">
                  ...
                  >
                    <div className="swiper-wrapper">
                      ...
                      <SwiperSlide>
                        <div className="image-partner-logo">
                          <img
                            src="/assets/images/brand/br10.png"
                            alt="image"
                          />
                        </div>
                      </SwiperSlide>
