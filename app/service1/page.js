...
export default function Service1() {
  ...
  return (
    <>
      <Layout headerStyle={2} breadcrumbTitle="Popular Services">
        <div>
              ...
              <div className="row relative z-index-3 mb-60">
                <div className="col-md-8">
                  <div className="heading-title optimize-olutions-left w-650">
                    <span className="sub-title text-blue2 font-man">
                      Security Solutions
                    </span>
                    <h2 className="title">
                      Comprehensive Protection for your{" "}
                      <span className="text-blue2">Business</span>
                    </h2>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="optimize-olutions-right">
                    <p className="mb-20">
                      Metrics for improving your site's performance over time
                      security measures like systems
                    </p>
                  ...
                  <div className="feature-h3-content">
                    <div className="heading-title mb-60">
                      ...
                      <h2 className="title">
                        ...
                        <span className="text-blue2">Services</span>
                      </h2>
                    </div>
                    <div
                      className="accordion accordion-h3"
                      id="accordionExample"
                    >
                ...
                <div className="col-lg-6">
                  <div className="image-wrapper-wcus3 relative">
                    <div className="image-wcus3 flex">
                      <img
                        src="/assets/images/service/cta-list1.jpg"
                        alt="imge"
                        className="wcus-pt"
                      />
                    </div>
                    <div className="quote-wcus-3 flex bg-5">
                      ...
                      <div className="content">
                        ...
                        <p>
                          Accelerate innovation with world match entire remote
                          team
                        </p>
                      </div>
                    </div>
                ...
                <div className="col-lg-6">
                  <div className="content-wrapper-wcus3">
                    <div className="heading-title mb-40">
                      ...
                      <h2 className="title">
                        Innovative Strategies for Maximum{" "}
                        <span className="text-blue2">SEO Impact</span>
                      </h2>
                      <p className="des">
                        We are at the forefront of technological innovation,
                        dedicated to providing comprehensive IT solutions that
                        empower businesses
                      </p>
                    </div>
                    <div className="row">
                      ...
                      <div className="col-sm-6">
                        <div className="icon-box-wcus style2">
                          ...
                          <p className="des">
                            Passion lies creating solution not only meet but
                            excee
                          </p>
                        </div>
                      </div>
              ...
              <div className="row align-center">
                <div className="col-md-7">
                  <div className="heading-title">
                    ...
                    <h2 className="title mb-40">
                      We believe in smart design, trust &amp; collaboration.
                    </h2>
                    <Link href="/#" className="button-src">
                      Read More <i className="icon-angle-right" />
                    </Link>
                ...
                <div className="col-md-5">
                  <div className="image-cta-service">
                    <img
                      src="/assets/images/service/cta-list3.jpg"
                      alt="image"
                    />
                    <div className="quote-feature-wrap">
                      <div className="counter  tf-counters">
                        <div
                          className="numbers number-style"
                          data-speed={2000}
                          data-to={25}
                          data-inviewport="yes"
                        >
