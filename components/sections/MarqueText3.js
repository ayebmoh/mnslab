								...
								<div className="marquee-inner to-left">
									<ul className="marqee-list d-flex marque-slider">
										<li className="marquee-item">
											...
											<span className="text-slider">Software development</span><i className="icon-asterisk" />
											...
											<span className="text-slider">Software Maintenance</span><i className="icon-asterisk" />
											<span className="text-slider">IT Consulting</span><i className="icon-asterisk" />
											<span className="text-slider">Dev ops</span><i className="icon-asterisk" />
										</li>
									</ul>
								</div>
							</div>
