      ...
      <section className="service-section-4 pt-122 pb-130">
        <div className="tf-container">
            ...
            <div className="col-lg-12">
              <div className="heading-title center m0-auto w-760 mb-70">
                ...
                <h2 className="title wow fadeInUpSmall" data-wow-delay=".3s">
                  Best Features We Provide For Our Mobile Apps
          ...
          <div className="row">
            <div className="col-lg-12">
              <ul
                className="nav nav-tabs-service nav-justified mb-70"
                id="myTab"
                role="tablist"
              >
                <li className="nav-item" onClick={() => handleTab(1)}>
                  <button
                    ...
                    aria-selected="true"
                  >
                    <i className="icon-deposit" /> Financial services
                  </button>
                </li>
                <li className="nav-item" onClick={() => handleTab(2)}>
                  <button
                    ...
                    aria-selected="false"
                  >
                    <i className="icon-store-management" /> Retail Services
                  </button>
                </li>
                <li className="nav-item" onClick={() => handleTab(3)}>
                  <button
                    ...
                    aria-selected="false"
                  >
                    <i className="icon-graduated" /> Education Services
                  </button>
                </li>
                <li className="nav-item" onClick={() => handleTab(4)}>
                  <button
                    ...
                    aria-selected="false"
                  >
                    <i className="icon-healthcare" /> Healthcare Services
                  </button>
                </li>
              </ul>
                  ...
                  <div className="row tab-service-wrap">
                    <div className="col-lg-7">
                      <div className="tab-service-content">
                        <div className="heading-title">
                          <h2 className="title">
                            Innovate Finance Pioneering Tomorrow's Digital
                            Wealth Experience
                          </h2>
                          <p className="des mb-30">
                            At veroeos accusamus tusto dignissimos ducimus
                            blanditiis voluptatum delenite atque corrupti quos
                            dolores et quas molestias excepturi sint occaecatie
                          </p>
                    ...
                    <div className="col-lg-5">
                      <div className="tab-service-image relative">
                        <img
                          src="/assets/images/service/service-h41.jpg"
                          alt="image"
                        />
                        <img
                          src="/assets/images/service/service-h42.jpg"
                          alt="image"
                          className="service1"
                        />
                        <div className="clip" />
